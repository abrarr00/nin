...
<body>
   ...
   <!-- Ganti Audio di sini -->
   <audio src="foto dan lagunya nah/D4VD - Here With Me ﾟ  ﾟ  (Lyrics).mp3" id="linkmp3" class="sembunyi"></audio>
   
   <div id="bodyblur">
     <!-- Wallpaper --><img src="foto dan lagunya nah/7442259.jpg" id="wallpaper"/><div id="beneranblur"></div>
   </div>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       <p id="kalimat">Gua Ada Sesuatu Nih Buat lu </p>

       <p id="pesan1">Klik 4 MIAWW di Bawah! 😆❤️</p>
       <div id="kolombaru">
         <li id="lv1">🐱</li>
         <li id="lv2">🐱</li>
         <li id="lv3">🐱</li>
